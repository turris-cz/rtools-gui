...
class Ui_Programmer(object):
    def setupUi(self, Programmer):
        ...
        self.label_6 = QtWidgets.QLabel(self.pageIntroReady)
        font = QtGui.QFont()
        font.setFamily("Sans")
        font.setPointSize(20)
        ...
        self.label_4 = QtWidgets.QLabel(self.pageWork)
        font = QtGui.QFont()
        font.setFamily("Sans")
        font.setPointSize(20)
    ...
    def retranslateUi(self, Programmer):
        ...
        self.label_6.setText(_translate("Programmer", "Programátor připraven"))
        self.scanBoardLabel.setText(_translate("Programmer", "Naskenujte kód desky:"))
        self.label_4.setText(_translate("Programmer", "#TYPE#"))
