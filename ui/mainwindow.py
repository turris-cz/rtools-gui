...
"}")
        ...
        self.verticalLayout_3.addWidget(self.serialNumberLabel)
        ...
        self.startStepsButton = QtWidgets.QPushButton(self.workPage)
        self.startStepsButton.setObjectName("startStepsButton")
        self.horizontalLayout_5.addWidget(self.startStepsButton)
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem7)
        spacerItem8 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem8)
        self.startTestsButton = QtWidgets.QPushButton(self.workPage)
        self.startTestsButton.setObjectName("startTestsButton")
        self.horizontalLayout_5.addWidget(self.startTestsButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.currentProgressBar.setFormat(_translate("MainWindow", "%v/%m"))
