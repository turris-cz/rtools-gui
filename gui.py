...
#
# Created: Mon Dec  2 10:18:41 2013
...
class Ui_Installer(object):
    def setupUi(self, Installer):
        ...
        self.verticalLayout_8 = QtGui.QVBoxLayout(self.stepTwo)
        self.verticalLayout_8.setObjectName(_fromUtf8("verticalLayout_8"))
        self.label_15 = QtGui.QLabel(self.stepTwo)
        self.label_15.setObjectName(_fromUtf8("label_15"))
        self.verticalLayout_8.addWidget(self.label_15)
        self.label_16 = QtGui.QLabel(self.stepTwo)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.progressBar = QtGui.QProgressBar(self.stepTwo)
        ...
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.stepThree)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.label_6 = QtGui.QLabel(self.stepThree)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        ...
        self.label_7 = QtGui.QLabel(self.stepThree)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.progressBar_2 = QtGui.QProgressBar(self.stepThree)
        ...
        self.stepFour = QtGui.QWidget()
        self.stepFour.setObjectName(_fromUtf8("stepFour"))
        self.verticalLayout_6 = QtGui.QVBoxLayout(self.stepFour)
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.label_9 = QtGui.QLabel(self.stepFour)
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.verticalLayout_6.addWidget(self.label_9)
        self.label_10 = QtGui.QLabel(self.stepFour)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.progressBar_3 = QtGui.QProgressBar(self.stepFour)
        ...
        self.stackedWidget.addWidget(self.stepFour)
    ...
    def retranslateUi(self, Installer):
        ...
        self.label_15.setText(_translate("Installer", "<h1>Krok 2</h1>", None))
...
"Vel exercitationem animi in accusantium voluptatem ea qui consequatur. Nisi explicabo aut voluptatem sit. Nisi numquam magnam rem totam. Sit sed qui omnis quis iusto.", None))
        self.label_6.setText(_translate("Installer", "<h1>Krok 3</h2>", None))
...
"Quia modi rerum asperiores sapiente odio et maiores. Quo sed rem repudiandae nostrum. Quos et qui laborum iste. Est consequatur adipisci aspernatur sapiente aut ducimus. Sunt totam dignissimos eos.", None))
        self.label_9.setText(_translate("Installer", "<h1>Krok 4</h1>", None))
