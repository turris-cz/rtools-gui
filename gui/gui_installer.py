...
#
# Created: Tue Jan 13 15:22:16 2015
...
class Ui_Installer(object):
    ...
    def retranslateUi(self, Installer):
        ...
        self.label_8.setText(_translate("Installer", "<html><head/><body><p>Zkontrolujte pracoviště pro programování a testování routeru TURRIS podle přiložené dokumentace. </p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte myš, klávesnici a monitor k programovacímu PC</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte datové kabely 2, 3, 5 a 6 do USB programovacího PC</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte ethernetový kabel z ethernetového portu programovacího PC do switche</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte napájecí adaptér 7,5 V k programovacímu routeru (&quot;Turris Programmer&quot;)</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte ethernetový kabel z WAN programovacího routeru do switche</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte plochý kabel 1 do I2C2 programovacího routeru (konektor P1)</li></ul></body></html>", None))
        self.startToScan.setText(_translate("Installer", "Pokračovat", None))
        self.label_3.setText(_translate("Installer", "<h1>Scan</h1>", None))
        self.label_5.setText(_translate("Installer", "<html><head/><body><p>Před samotným programováním je nezbýtné provést následující kroky:</p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Přilepte chladiče na procesor, LAN switch a USB3 chip</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Nalepte na konektor CN3 (LAN porty) malý štítek a odstřihněte z kotouče velké štítky, které přiložte k programované desce.</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Vložte paměťový modul DDR3 SODIMM do slotu</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Vložite baterii CR2032 pro zálohování RTC do konektoru BT1</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Nastavte DIP SWITCHe SW1 a SW2 pro flashování podle návodu</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připněte jumper na PINy konektoru J13 podle návodu</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Vložite WiFi kartu do mini PCIe slotu CN6 a přišroubujte 2 šroubky</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte datové kabely 1, 2, 3 a 5</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte desku D1 s SD kartou do konektoru P5</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Připojte napájecí 12 V adaptér </li><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Oscanujte čárový kód nalepený na konektor CN3 programované desky </li></ul></body></html>", None))
        ...
        self.label_10.setText(_translate("Installer", "<html><head/><body><p>V tomto kroku probíhá programování NOR paměti pomocí desky D1 s SD kartou.<br/></p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Chvíli počkejte, pokud se delší dobu nic neděje (posuvník se nezačne posouvat) zkuste:</li><ul type=\"circle\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Odpojit kabely 1, 2 a 3</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Zkontrolovat připojení SD karty</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Zkontrolovat, zda DIP SWITChe jsou nastaveny pro flashovaní</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Krátce stisknout tlačítko reset.</li></ul><p><br/></p><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Nyní se flashuje NOR pamět, počkejte cca 3 minuty.</li></ul></body></html>", None))
        ...
        self.label_12.setText(_translate("Installer", "<html><head/><body><p>V tomto kroku probíhá přepsání NAND paměti pamětí NOR.</p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Nastavte DIP SWITCHe SW1 a SW2 pro bootování z NAND paměti</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Podržte červené tlačítko reset aspoň 7 vteřin (LED dioda bude blikat a po uplynutí 7 vteřin začne svítit)</li><li style=\" margin-top:0px; margin-bottom:10px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Nyní probíhá factory reset, počkejte cca 3 minuty</li></ul></body></html>", None))
